<script>
    ...
    const defaultKeywords = { keywords: "final", version: "0.4.0" };
    export const settings = getSettings();

    function getSettings() {
        const { set, subscribe, update } = writable({ version: "0.4.0", zeros: "no", developer: "off", mode: "default", keywords: "final", edited: false });
